PRINT 'Start updating Schedule A, changing Average Cost per Participant to Maximum Cost per Participant'

update [dbo].[DocumentTemplates]

Set Body = '@model CJG.Application.Business.Models.DocumentTemplate.GrantApplicationTemplateModel
...
<div class="form--readonly">
	...
	<table id="tblExpenses" class="table table--expenses js-table-expense-list">
		<thead>
			<tr>
				...
				<th class="num-col">Maximum Cost per Participant</th>
	...
	@if (Model.ProgramType == ProgramTypes.WDAService)
	{
		...
		{
			<p class="schedule-a-ess-sum">Maximum amount allocated per Participant for Employment Support Services and Participant Financial Supports, combined, is $5,000.00.</p>
		}
	}
</div>'
...
PRINT 'Completed updating Schedule A'