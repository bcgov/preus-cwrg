...
namespace CJG.Infrastructure.EF
{
	...
	public class CJGContext : IdentityDbContext<ApplicationUser>
	{
		...
		public virtual DbSet<EvaluationFormQuestion> EvaluationFormQuestions { get; set; }
		public virtual DbSet<EvaluationFormResource> EvaluationFormResources { get; set; }
		public virtual DbSet<ClaimEvaluationFormQuestion> ClaimEvaluationFormQuestions { get; set; }
		#endregion
		...
		public virtual DbSet<GrantApplicationEvaluationNote> GrantApplicationEvaluationNotes { get; set; }
		...
		public virtual DbSet<AccountsReceivableEntry> AccountsReceivableEntries { get; set; }
		#endregion
		...
		public virtual DbSet<ClaimEvaluation> ClaimEvaluations { get; set; }
		public virtual DbSet<ClaimEvaluationAnswer> ClaimEvaluationAnswers { get; set; }
		...
		public virtual DbSet<ParticipantExitSurveyQuestion> ParticipantExitSurveyQuestions { get; set; }
		public virtual DbSet<ParticipantExitSurveyQuestionOption> ParticipantExitSurveyQuestionOptions { get; set; }
		public virtual DbSet<ParticipantExitSurveyAnswer> ParticipantExitSurveyAnswers { get; set; }

		public virtual DbSet<ParticipantWithdrawalSurveyQuestion> ParticipantWithdrawalSurveyQuestions { get; set; }
		public virtual DbSet<ParticipantWithdrawalSurveyQuestionOption> ParticipantWithdrawalSurveyQuestionOptions { get; set; }
		public virtual DbSet<ParticipantWithdrawalSurveyAnswer> ParticipantWithdrawalSurveyAnswers { get; set; }
		#endregion
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Organization>()
				...
				.Map(m =>
				{
					...
					m.ToTable("OrganizationDocuments");
				});
			#endregion
			...
			modelBuilder.Entity<GrantApplication>()
				.HasOptional(ga => ga.ProofOfPayment)
				.WithMany()
				.WillCascadeOnDelete(false);

			modelBuilder.Entity<GrantApplication>()
				.HasOptional(ga => ga.Attestation)
				.WithMany()
				.WillCascadeOnDelete(false);
			...
			modelBuilder.Entity<GrantApplicationEvaluation>()
				.HasRequired(e => e.GrantApplication)
				.WithMany();

			modelBuilder.Entity<SuccessStory>()
				.HasMany(c => c.Documents)
				.WithMany()
				.Map(m =>
				{
					m.MapLeftKey("SuccessStoryId");
					m.MapRightKey("AttachmentId");
					m.ToTable("SuccessStoryDocuments");
				});
			#endregion
			...
			modelBuilder.Entity<TrainingProviderInventory>()
				.HasMany(c => c.Documents)
				.WithMany()
				.Map(m =>
				{
					m.MapLeftKey("TrainingProviderInventoryId");
					m.MapRightKey("AttachmentId");
					m.ToTable("TrainingProviderInventoryDocuments");
				});
