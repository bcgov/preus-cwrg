...
namespace CJG.Application.Services.Notifications
{
	public class NotificationViewModel
	{
		...
		public NotificationViewModel(GrantApplication grantApplication, INotificationRecipient applicant, HttpContextBase httpContext = null)
		{
			...
			ExitFormLink = grantApplication.InvitationKey != Guid.Empty
				? $"{BaseURL}/Part/ExitForm/{grantApplication.InvitationKey}"
				: string.Empty;
		}
