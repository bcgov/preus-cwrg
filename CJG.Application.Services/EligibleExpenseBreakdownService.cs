...
namespace CJG.Application.Services
{
	...
	public class EligibleExpenseBreakdownService : Service, IEligibleExpenseBreakdownService
	{
		...
		public EligibleExpenseBreakdown GetForOccupationalSkillsTraining(int eligibleExpenseTypeId)
		{
			return _dbContext.EligibleExpenseBreakdowns
				.Where(b => b.EligibleExpenseTypeId == eligibleExpenseTypeId)
				.Where(b => b.IsActive)
				.ToList()
