...
namespace CJG.Core.Entities
{
	...
	public class ReportRate : EntityBase
    {
        ...
        {
            FiscalYear = fiscal ?? throw new ArgumentNullException(nameof(fiscal));
            FiscalYearId = fiscal.Id;
            GrantProgram = program ?? throw new ArgumentNullException(nameof(program));
            GrantProgramId = program.Id;
            GrantStream = stream ?? throw new ArgumentNullException(nameof(stream));
            GrantStreamId = stream.Id;
        }
    }
}
