...
namespace CJG.Core.Entities
{
	...
	public class EligibleCostBreakdown : EntityBase
	{
		...
		/// <summary>
		/// get/set - The user defined cost name. Used on PFS costs when allowed.
		/// </summary>
		[DisplayName("Custom Cost Title")]
		...
		public void Clone(EligibleCostBreakdown bd)
		{
			EligibleExpenseBreakdownId = bd.EligibleExpenseBreakdownId;
			EstimatedCost = bd.EstimatedCost;
			AssessedCost = bd.AssessedCost;
			CustomCostTitle = bd.CustomCostTitle;
			IsEligible = bd.IsEligible;
			AddedByAssessor = bd.AddedByAssessor;
		}
		#endregion
	}
}
