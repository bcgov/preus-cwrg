...
namespace CJG.Core.Entities
{
	...
	public class NotificationQueue : EntityBase
	{
		...
		public NotificationQueue(GrantApplication grantApplication, INotificationRecipient recipient, string sender, string body, string subject, NotificationType type)
		{
			...
			EmailRecipients = recipient.EmailAddress;
