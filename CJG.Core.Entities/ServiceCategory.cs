...
{
	/// <summary>
	/// Convenience Enum so we don't have to look up Service Category by it's Caption. 
	/// </summary>
	public enum ServiceCategoryEnum
	{
		EmploymentSupportServices = 1, 
		SkillsTraining = 2,
		ParticipantFinancialSupports = 3,
		EmploymentExperience = 4,  // Inactive
		AdministrationFees = 5
	}
