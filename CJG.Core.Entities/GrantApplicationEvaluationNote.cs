...
{
	/// <summary>
	/// <typeparamref name="GrantApplicationEvaluationNote"/> class, provides the ORM with a way to manage notes in the system.
	/// </summary>
	public class GrantApplicationEvaluationNote : EntityBase
	{
		/// <summary>
		...
		/// </summary>
		public GrantApplicationEvaluationNote()
		{ }
		...
		public GrantApplicationEvaluationNote(GrantApplication grantApplication, NoteType noteType, InternalUser creator, string content, Attachment attachment = null) : this(grantApplication, noteType, content, attachment)
		{
		...
		/// <param name="content"></param>
		/// <param name="attachment"></param>
		public GrantApplicationEvaluationNote(GrantApplication grantApplication, NoteType noteType, string content, Attachment attachment = null)
		{
		...
		/// <param name="content"></param>
		/// <param name="attachment"></param>
		public GrantApplicationEvaluationNote(GrantApplication grantApplication, NoteTypes noteType, InternalUser creator, string content, Attachment attachment = null) : this(grantApplication, noteType, content, attachment)
		{
			Creator = creator ?? throw new ArgumentNullException(nameof(creator));
			CreatorId = creator.Id;
		}
		...
		/// <param name="content"></param>
		/// <param name="attachment"></param>
		public GrantApplicationEvaluationNote(GrantApplication grantApplication, NoteTypes noteType, string content, Attachment attachment = null)
		{
			if (string.IsNullOrEmpty(content))
				throw new ArgumentNullException(nameof(content));
