...
namespace CJG.Core.Entities
{
	...
	public enum ApplicationStateInternal
	{
		...
		/// <summary>
		/// This is a placeholder state. It is not actually used in the Workflow. It is used to allow Queue filtering on "New + ReturnedToDraft != null".
		/// </summary>
		[Description("Returned to Draft")]
		ReturnedToDraft = 101,

		/// <summary>
		/// This is a placeholder state. It is not actually used in the Workflow. It is used to allow Queue filtering on "New + Resubmitted != null".
		/// </summary>
		[Description("New (Resubmitted)")]
		NewResubmitted = 102
	}
}