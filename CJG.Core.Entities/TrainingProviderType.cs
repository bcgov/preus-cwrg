namespace CJG.Core.Entities
{
	...
	public class TrainingProviderType : LookupTable<int>
	{
		...
		public int ProofOfInstructorQualifications { get; set; } = 0;
		public int CourseOutline { get; set; } = 0;
		public TrainingProviderTypeUsage UseForProviderTypes { get; set; }
		/// <summary>
		/// Creates a new instance of a <typeparamref name="TrainingProviderType"/> object.
		/// </summary>
		public TrainingProviderType()
		{
		}
		...
		{
			PrivateSectorValidationType = validationType;
		}
	}
}
