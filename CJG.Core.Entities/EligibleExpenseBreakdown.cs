...
namespace CJG.Core.Entities
{
	...
	public class EligibleExpenseBreakdown : LookupTable<int>
	{
		...
		/// <summary>
		/// get/set - Allow the applicant to specify their own description of their Service: ie: Other [Drink budget]. Used only in ESS. 
		/// </summary>
		[DefaultValue(false)]
		...
		{
			ServiceLineId = serviceLine?.Id ?? throw new ArgumentNullException(nameof(serviceLine));
			Description = serviceLine.Description;
			EnableCost = serviceLine.ServiceCategory.ServiceTypeId == ServiceTypes.SkillsTraining ? true : false;
			EnableCustomTitle = serviceLine.EnableCustomTitle;
		}
		#endregion
