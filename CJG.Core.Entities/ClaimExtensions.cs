...
namespace CJG.Core.Entities
{
	...
	public static class ClaimExtensions
	{
		...
		/// <param name="claim"></param>
		/// <returns></returns>
		public static bool IsPaymentRequested(this Claim claim)
		{
			return claim.ClaimState.In(ClaimState.Unassessed);
		}
		...
		public static bool IsEvaluationComplete(this Claim claim)
		{
			if (claim.ClaimEvaluation == null)
				return false;

			var allAnswersHaveResponses = claim.ClaimEvaluation.EvaluationAnswers
				.Where(ea => ea.QuestionType == ClaimEvaluationFormQuestionType.YesNoOrNa)
				.All(ea => ea.AnswerGiven > 0);

			return allAnswersHaveResponses;
		}
	}
}
