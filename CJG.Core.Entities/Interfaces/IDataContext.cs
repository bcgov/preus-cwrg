...
namespace CJG.Infrastructure.Entities
{
	public interface IDataContext : IDisposable
	{
		...
		DbSet<ChecklistCategory> ChecklistCategories { get; }
		DbSet<ChecklistItem> ChecklistItems { get; }
		DbSet<EvaluationFormQuestion> EvaluationFormQuestions { get; }
		DbSet<EvaluationFormResource> EvaluationFormResources { get; }
		DbSet<ClaimEvaluationFormQuestion> ClaimEvaluationFormQuestions { get; }
		#endregion
		...
		DbSet<GrantApplicationEvaluationNote> GrantApplicationEvaluationNotes { get; }
		...
		DbSet<ClaimEvaluation> ClaimEvaluations { get; }
		DbSet<ClaimEvaluationAnswer> ClaimEvaluationAnswers { get; }
		...
		DbSet<ParticipantExitSurveyQuestion> ParticipantExitSurveyQuestions { get; }
		DbSet<ParticipantExitSurveyQuestionOption> ParticipantExitSurveyQuestionOptions { get; }
		DbSet<ParticipantExitSurveyAnswer> ParticipantExitSurveyAnswers { get; }

		DbSet<ParticipantWithdrawalSurveyQuestion> ParticipantWithdrawalSurveyQuestions { get; }
		DbSet<ParticipantWithdrawalSurveyQuestionOption> ParticipantWithdrawalSurveyQuestionOptions { get; }
		DbSet<ParticipantWithdrawalSurveyAnswer> ParticipantWithdrawalSurveyAnswers { get; }
		#endregion
