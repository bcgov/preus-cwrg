...
namespace CJG.Core.Entities
{
	...
	public enum ApplicationWorkflowTrigger
	{
		...
		/// <summary>
		/// AssessEligibility - Assessor returns the Claim from reimbursement assessment to eligibility assessment.
		/// </summary>
		...
		/// </summary>
		[Description("Edit Application Project Description")]
		...
		/// <summary>
		/// ReturnApplicationUnassessed - Director returns the application unassessed.
		/// </summary>
		[Description("Return to Applicant Unassessed")]
		ReturnUnassessed = 65,
		/// <summary>
		/// ChangeApplicantContact - Whether the applicant contact button is enabled
		/// </summary>
		[Description("Enable the Change Applicant Contact button")]
		ChangeApplicantContactButton = 66,

		/// <summary>
		/// ReturnToDraft - Whether the application can be sent from Under Assessment to Draft
		/// </summary>
		[Description("Return to Draft")]
		ReturnUnderAssessmentToDraft = 67,

		/// <summary>
		/// ReturnOfferToAssessment - Director returns the Issued Offer to the Assessor for additional information.
		/// </summary>
		[Description("Return Offer to Assessment")]
		ReturnOfferToAssessment = 68,

		/// <summary>
		/// ReturnWithdrawnToAssessment - Director returns a Ministry Withdrawn Offer back to Under Assessment.
		/// </summary>
		[Description("Return Withdrawn Offer to Assessment")]
		ReturnWithdrawnOfferToAssessment = 69,

		/// <summary>
		/// ReturnUnassessedToNew - Director returns an Unfunded Application (Return to Applicant Unassessed) to New.
		/// </summary>
		[Description("Return Unassessed to New")]
		ReturnUnassessedToNew = 70,

		/// <summary>
		/// ReverseCancelledByMinistry - Director returns an Agreement Accept that is Cancelled By Ministry to Under Assessment.
		/// </summary>
		[Description("Reverse Cancelled by Ministry")]
		ReverseAgreementCancelledByMinistry = 71,

		/// <summary>
		/// EditProofOfPayments - The Proof of Payment documents can be edited on a Grant Application
		/// </summary>
		[Description("Edit Proof of Payments")]
		EditProofOfPayments = 80,

		/// <summary>
		/// EditAttestation - The Participant Financial Supports Attestation can be edited on a Grant Application
		/// </summary>
		[Description("Edit Participant Financial Supports Attestation")]
		EditAttestation = 81,

		/// <summary>
		/// CompleteEvaluation - The Application Evaluation is ready for completion by an Assessor
		/// </summary>
		[Description("Complete Evaluation")]
		CompleteEvaluation = 100,

		/// <summary>
		/// EditClaimAR - The Claim can have it's Accounts Receivable amounts updated
		/// </summary>
		EditClaimAR = 120,
