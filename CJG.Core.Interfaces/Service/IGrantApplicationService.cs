...
namespace CJG.Core.Interfaces.Service
{
	public interface IGrantApplicationService : IService
	{
		...
		void EditRecommendForDenialReason(GrantApplication grantApplication, string reason = null);

		void IssueOffer(GrantApplication grantApplication);

		void ReturnOfferToAssessment(GrantApplication grantApplication);

		void ReturnToDraft(GrantApplication grantApplication, string reason = null);
		...
		void UpdateChecklist(GrantApplication grantApplication, List<int> modelChecklistItemIds);
	}
}