...
namespace CJG.Core.Interfaces.Service
{
	public interface IStaticDataService : IService
	{
		...
		IEnumerable<TrainingProviderType> GetTrainingProviderTypes(TrainingProviderTypeUsage usage);
		...
		IEnumerable<FiscalYear> GetFiscalYears(int? limitEndYearRange = null);
		FiscalYear GetFiscalYear(int id);

		IEnumerable<TrainingPeriod> GetTrainingPeriods(int grantStreamId);
		IEnumerable<TrainingPeriod> GetTrainingPeriodsForFiscalYear(int fiscalYearId);
		IEnumerable<TrainingPeriod> GetTrainingPeriodsForFiscalYear(int fiscalYearId,int grantProgramId);
