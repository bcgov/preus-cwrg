...
namespace CJG.Core.Interfaces.Service
{
	public interface IGrantOpeningService : IService
	{
		...
		GrantOpening GetCurrentGrantOpening(int grantOpeningId);
		...
		IDictionary<int, decimal[]> GetGrantOpeningFinancialsInTrainingPeriods(int fiscalYearId, int programId, int grantStreamId, decimal unclaimedSlippageRate);
