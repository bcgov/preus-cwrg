...
namespace CJG.Application.Business.Models
{
	public class ClaimModel
	{
		...
		public bool ReceiptsAreRequired { get; set; }
		#endregion
		...
		public ClaimModel(Claim claim)
		{
			...
			//receipts are required when applicant claims for Id 10 "Employment Support Services" or Id 11 "Skills Training"
			this.ReceiptsAreRequired = this.EligibleCosts
											.Any(a=> (a.EligibleExpenseTypeId == 10 && a.ClaimCost > 0)
											      || (a.EligibleExpenseTypeId == 11 && a.ClaimCost > 0));
