	...
	public class WorkflowController : BaseController
	{
		...
		public JsonResult BeginAssessment(WorkflowViewModel model)
		{
			try
			{
				var grantApplication = _grantApplicationService.Get(model.ApplicationWorkflowViewModel.Id);
				grantApplication.RowVersion = Convert.FromBase64String(model.ApplicationWorkflowViewModel.RowVersion);
				if (!model.ApplicationWorkflowViewModel.AssessorId.HasValue)
					throw new InvalidOperationException("An assessor must be assigned before beginning assessment.");
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[HttpPut, Route("Workflow/Return/To/Draft", Name = "ReturnUnderAssessmentToDraft")]
		public JsonResult ReturnToDraft(WorkflowViewModel model)
		{
			try
			{
				var grantApplication = _grantApplicationService.Get(model.ApplicationWorkflowViewModel.Id);
				grantApplication.RowVersion = Convert.FromBase64String(model.ApplicationWorkflowViewModel.RowVersion);
				_grantApplicationService.ReturnToDraft(grantApplication, model.ApplicationWorkflowViewModel.ReasonToReturnToDraft);
				model = new WorkflowViewModel(grantApplication, User, x => Url.RouteUrl(x));
			}
			catch (Exception ex)
			{
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[HttpPut, Route("Workflow/Recommend/For/Denial/Edit", Name = "EditRecommendForDenialReasons")]
		public JsonResult EditRecommendForDenialReason(WorkflowViewModel model)
		{
			try
			{
				var grantApplication = _grantApplicationService.Get(model.ApplicationWorkflowViewModel.Id);
				grantApplication.RowVersion = Convert.FromBase64String(model.ApplicationWorkflowViewModel.RowVersion);
				_grantApplicationService.EditRecommendForDenialReason(grantApplication, model.ApplicationWorkflowViewModel.ReasonToDeny);
				model = new WorkflowViewModel(grantApplication, User, x => Url.RouteUrl(x));
			}
			catch (Exception ex)
			{
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[HttpPut, Route("Workflow/Return/Unassessed", Name = "ReturnUnassessed")]
		public JsonResult ReturnUnassessed(WorkflowViewModel model)
		{
			try
			{
				var grantApplication = _grantApplicationService.Get(model.ApplicationWorkflowViewModel.Id);
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[HttpPut, Route("Workflow/Return/Unassessed/To/New", Name = "ReturnUnassessedToNew")]
		public JsonResult ReturnUnassessedToNew(WorkflowViewModel model)
		{
			try
			{
				var grantApplication = _grantApplicationService.Get(model.ApplicationWorkflowViewModel.Id);
				grantApplication.RowVersion = Convert.FromBase64String(model.ApplicationWorkflowViewModel.RowVersion);
				_grantApplicationService.ReturnUnassessedToNew(grantApplication);
				model = new WorkflowViewModel(grantApplication, User, x => Url.RouteUrl(x));
			}
			catch (Exception ex)
			{
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[HttpPut, Route("Workflow/Offer/Return/To/Assessment", Name = "ReturnWithdrawnOfferToAssessment")]
		public JsonResult ReturnWithdrawnOfferToAssessment(WorkflowViewModel model)
		{
			try
			{
				var grantApplication = _grantApplicationService.Get(model.ApplicationWorkflowViewModel.Id);
				grantApplication.RowVersion = Convert.FromBase64String(model.ApplicationWorkflowViewModel.RowVersion);
				_grantApplicationService.ReturnWithdrawnOfferToAssessment(grantApplication);
				model = new WorkflowViewModel(grantApplication, User, x => Url.RouteUrl(x));
			}
			catch (Exception ex)
			{
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[HttpPut, Route("Workflow/Return/Offer", Name = "ReturnOfferToAssessment")]
		public JsonResult ReturnOfferToAssessment(WorkflowViewModel model)
		{
			try
			{
				var grantApplication = _grantApplicationService.Get(model.ApplicationWorkflowViewModel.Id);
				grantApplication.RowVersion = Convert.FromBase64String(model.ApplicationWorkflowViewModel.RowVersion);
				_grantApplicationService.ReturnOfferToAssessment(grantApplication);
				model = new WorkflowViewModel(grantApplication, User, x => Url.RouteUrl(x));
			}
			catch (Exception ex)
			{
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[HttpPut, Route("Workflow/Reverse/CancelledAgreement", Name = "ReverseAgreementCancelledByMinistry")]
		public JsonResult ReverseCancelledAgreement(WorkflowViewModel model)
		{
			try
			{
				var grantApplication = _grantApplicationService.Get(model.ApplicationWorkflowViewModel.Id);
				grantApplication.RowVersion = Convert.FromBase64String(model.ApplicationWorkflowViewModel.RowVersion);
				_grantApplicationService.ReverseCancelledApplicationAgreement(grantApplication);
				model = new WorkflowViewModel(grantApplication, User, x => Url.RouteUrl(x));
			}
			catch (Exception ex)
			{
