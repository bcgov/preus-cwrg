...
namespace CJG.Web.External.Areas.Int.Controllers
{
	...
	public class GrantProgramController : BaseController
	{
		...
		/// <param name="denialReasonService"></param>
		public GrantProgramController(
			...
			IDenialReasonService denialReasonService
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[Route("Program/Denial/Reasons")]
		public JsonResult UpdateGrantProgramDenialReasons(GrantProgramDenialReasonListViewModel model)
		{
			try
			{
				var grantProgram = _grantProgramService.Get(model.Id);
		...
		[PreventSpam]
		[ValidateRequestHeader]
		[Route("Program/Denial/Reason")]
		public JsonResult AddGrantProgramDenialReason(GrantProgramDenialReasonViewModel model)
		{
			try
			{
				if (ModelState.IsValid)
