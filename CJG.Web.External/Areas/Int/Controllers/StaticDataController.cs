...
;
		...
		public JsonResult GetTrainingProviderTypes()
		{
			...
			try
			{
				var entity = _staticDataService.GetTrainingProviderTypes(TrainingProviderTypeUsage.TrainingProvider);
		...
		[HttpGet]
		[OutputCache(CacheProfile = "StaticData", VaryByParam = "none", Location = OutputCacheLocation.ServerAndClient)]
		[Route("Application/Training/Provider/EssTypes")]
		public JsonResult GetEssTrainingProviderTypes()
		{
			...
			try
			{
				var entity = _staticDataService.GetTrainingProviderTypes(TrainingProviderTypeUsage.EmploymentSupportServices);
				model = entity.Select(o => new KeyValueParent<int, string, TrainingProviderPrivateSectorValidationTypes>(o.Id, o.Caption, o.PrivateSectorValidationType)).ToArray();
			}
			catch (Exception ex)
			{
