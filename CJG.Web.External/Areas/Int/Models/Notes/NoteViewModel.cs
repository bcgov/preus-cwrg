...
namespace CJG.Web.External.Areas.Int.Models.Notes
{
	public class NoteViewModel : BaseViewModel
	{
		...
		public NoteViewModel(Note note, IPrincipal user, bool includeAttachment = true, bool replaceNewLines = false)
		{
			...
			AllowEdit = IsCreator && !note.NoteType.IsSystem;
		}

		// Make the property going in Interfaced
		public NoteViewModel(GrantApplicationEvaluationNote note, IPrincipal user, bool includeAttachment = true, bool replaceNewLines = false)
		{
			if (note == null)
				throw new ArgumentNullException(nameof(note));
