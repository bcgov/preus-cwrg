...
namespace CJG.Web.External.Areas.Int.Models.GrantStreams
{
    public class GrantStreamViewModel : BaseViewModel
	{
		...
		//[Required(ErrorMessage = "Grant stream objective is required."), Display(Name = "Intent")]
		...
		#region Reporting
		public bool IsCoreStream { get; set; }
		...
		public List<GrantStreamQuestionViewModel> StreamQuestions { get; set; } = new List<GrantStreamQuestionViewModel>();
		public List<GrantStreamChecklistViewModel> CheckListCategories { get; set; } = new List<GrantStreamChecklistViewModel>();
		...
		public GrantStreamViewModel(GrantStream grantStream, IServiceCategoryService serviceCategoryService, IStaticDataService staticDataService, IGrantStreamService grantStreamService)
		{
			...
			if (serviceCategoryService == null)
				throw new ArgumentNullException(nameof(serviceCategoryService));
			...
			CheckListCategories = grantStreamService.GetGrantStreamChecklist(grantStream.Id)
					.Select(n => new GrantStreamChecklistViewModel(n)).ToList();
		}
	}
}
