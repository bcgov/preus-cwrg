...
namespace CJG.Web.External.Areas.Int.Models
{
	public class ApplicantContactViewModel : BaseViewModel
	{
		...
		public bool HasProxyContact { get; set; }
		public string ProxyContactDesignation { get; set; }
		public string ProxyContactName { get; set; }
		public string ProxyContactEmail { get; set; }
		public string ProxyContactPhoneNumber { get; set; }
		...
		public ApplicantContactViewModel(GrantApplication grantApplication, IUserService userService, IPrincipal user)
		{
			...
			AlternatePhoneNumberViewModel = grantApplication.AlternatePhoneNumber != null
				? new PhoneViewModel(grantApplication.AlternatePhoneNumber, grantApplication.AlternatePhoneExtension)
				: null;
