app.controller('ServiceProviderView', function ($scope, $attrs, $controller, $timeout, Utils, ngDialog) {
  ...
  function loadProviderTypes() {
    $scope.load({
      url: '/Ext/Training/Provider/EssTypes',
      set: 'ProviderTypes'
    });
  };
 ...
 **/
  $scope.setTrainingProviderTypeDetails = function () {
    $scope.model.ServiceProvider.ProofOfInstructorQualifications = $scope.ProviderTypes.find(function (element) {
      return element.Id == $scope.model.ServiceProvider.TrainingProviderTypeId;
    }).ProofOfInstructorQualifications;
    $scope.model.ServiceProvider.CourseOutline = $scope.ProviderTypes.find(function (element) {
      return element.Id == $scope.model.ServiceProvider.TrainingProviderTypeId;
    }).CourseOutline;
  }
