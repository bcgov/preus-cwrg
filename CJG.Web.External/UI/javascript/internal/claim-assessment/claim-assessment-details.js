...
app.controller('ClaimAssessmentDetails', function ($scope, $attrs, $controller, $timeout, Utils, ngDialog, moment) {
  $scope.section = {
  ...
  **/
  ...
  function resetEditState() {
    $scope.section.editingClaim = false;
    $scope.section.editingAR = false;
    $scope.section.save.url = "/Int/Claim";
  }
  ...
  $scope.editClaim = function ($event) {
    $scope.section.editingClaim = true;
    $scope.section.editingAR = false;
    $scope.section.save.url = "/Int/Claim";
   ...
   * @returns {void}
   */
  //$scope.editClaimAR = function ($event) {
  //  $scope.section.editingClaim = false;
  //  $scope.section.editingAR = true;
  //  $scope.section.save.url = "/Int/Claim/AR";
  ...
  $scope.resetEditState = function ($event) {
    resetEditState();
  }
