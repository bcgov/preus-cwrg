app.controller('TrainingProviderBase', function ($scope, $attrs, $controller, $timeout, Utils, ngDialog) {
  ...
  **/
  ...
  function loadEssTrainingProviderTypes() {
    return $scope.load({
      url: '/Int/Application/Training/Provider/EssTypes',
      set: 'essTrainingProviderTypes',
      condition: !$scope.essTrainingProviderTypes || !$scope.essTrainingProviderTypes.length,
      overwrite: false,
      localCache: false
    });
  }
