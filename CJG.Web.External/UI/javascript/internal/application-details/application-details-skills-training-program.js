...
app.controller('SkillsTrainingProgram', function ($scope, $attrs, $controller, $timeout) {
  $scope.section = {
  ...
  if (typeof ($scope.CipsCode1) === 'undefined') {
    $scope.CipsCode1 = [];
  }
  ...
  /**
 * Make AJAX request for Occupational Training.
 * @function loadOccupationalTraining 
 * @returns {Promise}
 **/
  function loadOccupationalTraining() {
    return $scope.load({
      url: '/Int/Application/Skills/Training/OccupationalTraining',
      set: 'section.occupationalTraining'
    });
  }
...
*/
  ...
  function setServiceLineBreakdownCaption() {
    ...
    if (serviceLine)
      $scope.model.ServiceLineBreakdownCaption = serviceLine.BreakdownCaption;
  }
