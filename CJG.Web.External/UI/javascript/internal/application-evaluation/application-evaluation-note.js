app.controller('ApplicationEvaluationNote', function($scope, $controller, $timeout, Utils, ngDialog) {
    Object.assign({
        name: 'ApplicationEvaluationNote',
        displayName: 'Application Evaluation Note'
      },
      $scope.section);
    ...
    function loadNote(id) {
      return $scope.load({
        url: '/Int/Application/Evaluation/Note/' + id,
    ...
    $scope.deleteNote = function() {
      return $scope.confirmDialog('Delete Note', 'Do you want to delete this note?')
        .then(function() {
          return $scope.ajax({
            url: '/Int/Application/Evaluation/Note/Delete',
            method: 'PUT',
            data: function() {
    ...
    $scope.dzNoteAttachmentDialog = function(title, attachment) {
      ...
      return ngDialog.openConfirm({
        ...
        controller: function($scope, Utils) {
          ...
          $scope.dzOptions = {
            url: '/Int/Application/Evaluation/Note/DropzoneUpload',
