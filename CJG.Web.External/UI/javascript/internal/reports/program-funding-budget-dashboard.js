app.controller('ProgramFundingBudgetDashboard', function ($scope, $attrs, $controller, $timeout) {
  $scope.section = {
    name: 'ProgramFundingBudgetDashboard',
    save: {
      url: '/Int/Admin/Reports/LMDAWDAReport/Dashboard/Save',
      method: 'POST',
      data: function () {
  ...
  function loadFiscalYears() {
    return $scope.load({
        url: '/Int/Admin/Reports/LMDAWDAReport/FiscalYears',
        set: 'fiscalYears'
      })
      .catch(angular.noop);
  }
  ...
  function loadDirectorDashboard() {
    return $scope.load({
      url: '/Int/Admin/Reports/LMDAWDAReport/Dashboard/' + $scope.section.fiscalYearId,
      set: 'model'
    });
  }
  ...
  $scope.export = function () {
    return $scope.ajax({
      url: '/Int/Admin/Reports/LMDAWDAReport/Dashboard/Export',
      method: 'POST',
      data: $scope.model
