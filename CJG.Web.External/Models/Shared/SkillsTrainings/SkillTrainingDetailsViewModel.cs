...
namespace CJG.Web.External.Models.Shared.SkillsTrainings
{
	public class SkillTrainingDetailsViewModel : BaseTrainingProgramViewModel
	{
										  ...
										  HttpPostedFileBase[] files = null)
		{
			...
			{
				if (internalUser)
					trainingProgram.EligibleCostBreakdown = new EligibleCostBreakdown(eligibleCost, eligibleExpenseBreakdown, 0) { AssessedCost = TotalCost };
				else
					trainingProgram.EligibleCostBreakdown = new EligibleCostBreakdown(eligibleCost, eligibleExpenseBreakdown, TotalCost);
			...
			{
				if (internalUser)
					trainingProgram.EligibleCostBreakdown.AssessedCost = TotalCost;
				else
